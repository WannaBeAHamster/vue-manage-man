<template>
  <el-menu default-active="1-4-1" class="el-menu-vertical-demo" @open="handleOpen" @close="handleClose" :collapse="isCollapse" background-color="#545c64" text-color="#fff" active-text-color="#ffd04b">
    ...
    <el-submenu v-for="item in hasChildren" :key="item.label" :index="item.label">
      ...
      <el-menu-item-group v-for="list in item.children" :key="list.path">
        <el-menu-item @click="clickMenu(list)" :index="list.path">{{ list.label }}</el-menu-item>
      </el-menu-item-group>
    </el-submenu>
  </el-menu>
</template>
